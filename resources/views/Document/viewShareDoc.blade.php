                                ...
                                <div class="col-sm-12">
                                    <table id="example1" class="table dataTable "
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting  text-left" tabindex="0" aria-controls="example1"
                                                rowspan="1"
                                                colspan="1" aria-label="CSS grade: activate to sort column ascending">
                                                Action
                                            </th>
                                        ...
                                        @foreach($documents as $document)
                                            <tr role="row" class="">
                                                ...
                                                <td id="id" tabindex="0" class="sorting_1">{{$document->document->name}}</td>
                                                <td>{{$document->document->tutor->name}}</td>
                                                <td>
                                                    @if($document->document->isPublic===1)
                                                        Public
                                                    @else
                                                        Private
                                                    @endif
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href="/viewfile/{{$document->document_id}}">
                                                        <i class="fas fa-eye">
                                                        </i>
                                                    ...
                                                    @if($document->document->isPublic===1)
                                                    <a class="btn btn-primary btn-sm" href="/file/{{$document->document_id}}">
